package com.example.fibra_labeling.fibrafil.ui.screen.inventario.details
...
import com.example.fibra_labeling.fibrafil.ui.screen.inventario.details.component.FioriCardIncCompact
...
fun IncScreen(
    ...
    onNavigationSetting: ((SettingsDestination) -> Unit)? = null,
    docEntry: Int
){
    ...
    LaunchedEffect(Unit) {
        viewModel.eventoNavegacion.collect { destino ->
            when (destino) {
                "printSetting"->onNavigationSetting?.invoke(SettingsDestination.Printer)
            }
        }
    }
