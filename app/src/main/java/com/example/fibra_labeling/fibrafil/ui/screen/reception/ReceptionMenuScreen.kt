package com.example.fibra_labeling.fibrafil.ui.screen.reception
                    ...
                    CustomPrintCard(
                        ...
                        onClick = {
                            when (categories[index].navigation) {
                                "purchase" -> {
                                    // Navigate to purchase reception flow
                                    navController.navigate(FibraFilDestination.Reception.SupplierList.route)
                                }
                                "warehouse" -> {
                                    // Navigate to warehouse entry flow
                                    navController.navigate("shared/reception")
                                }
                                "return" -> {
                                    // Navigate to return reception flow
                                    navController.navigate("shared/reception")
                                }
                            }
                        }
