...
import com.example.fibra_labeling.shared.ui.screen.component.CustomCountingWidget
import com.example.fibra_labeling.shared.ui.screen.component.CustomSearch
import com.example.fibra_labeling.shared.ui.screen.component.CustomSwipeableItem
import com.example.fibra_labeling.fibraprint.ui.screen.inventario.details.component.PrintFioriCardIncCompact
...
fun PrintIncScreen(
    ...
    docEntry: Int,
    onNavigationToSetting:((SettingsDestination)->Unit)?=null,
) {
    ...
    LaunchedEffect(Unit) {
        viewModel.eventoNavegacion.collect { destino ->
            when (destino) {
                "printSetting"->onNavigationToSetting?.invoke(SettingsDestination.Printer)
                "zplSetting" ->onNavigationToSetting?.invoke(SettingsDestination.ZplTemplate)
            }
        }
    }
    LaunchedEffect(Unit) {
