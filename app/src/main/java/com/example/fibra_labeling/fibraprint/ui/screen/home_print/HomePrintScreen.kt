...
fun HomePrintScreen(
    ...
    val categories = listOf(
        ...
        // HomeCategories(R.drawable.ic_transfer, stringResource(R.string.category_transfers), "transfer"), // Legacy - disabled
        HomeCategories(R.drawable.ic_inventory, stringResource(R.string.category_inventory), "inventory"),
        // HomeCategories(R.drawable.ic_packing, stringResource(R.string.category_packing_list), "packingList"), // Legacy - disabled
        // HomeCategories(R.drawable.ic_report, stringResource(R.string.category_production_receipt), "production"), // Legacy - disabled
            ...
            AlertDialog(
                ...
                text = {
                    Column(
                        ...
                        FilledTonalButton(
                            onClick = { onNavigateToSettings?.invoke(SettingsDestination.Server) },
                                ...
                                CustomPrintCard(
                                    ...
                                    onClick = {
                                        when (categories[index].navigation) {
                                            "print" -> navController.navigate(FibraPrintDestination.Print.Main.route)
                                            "reception" -> navController.navigate(FibraPrintDestination.Reception.route)
                                            // "transfer" -> {
                                            //     // Legacy route - could be moved to shared or removed
                                            //     //navController.navigate("transfer")
                                            // }
                                            "inventory" -> navController.navigate(FibraPrintDestination.Inventory.OncList.route)
                                            // "packingList" -> {
                                            //     // Legacy route - could be moved to shared or removed
