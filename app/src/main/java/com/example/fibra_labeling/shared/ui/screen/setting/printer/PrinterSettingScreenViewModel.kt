...
import com.example.fibra_labeling.shared.ui.screen.setting.printer.form.PrintFormErrorState
import com.example.fibra_labeling.shared.ui.screen.setting.printer.form.PrintFormState
import com.example.fibra_labeling.shared.ui.screen.setting.printer.form.isFormValid
import com.example.fibra_labeling.shared.ui.screen.setting.printer.form.validatePrintForm
import kotlinx.coroutines.ExperimentalCoroutinesApi
import kotlinx.coroutines.flow.SharingStarted
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.catch
import kotlinx.coroutines.flow.first
import kotlinx.coroutines.flow.flatMapLatest // Added import
...
class PrinterSettingScreenViewModel(
    ...
    val zplLabels: StateFlow<List<ZplLabel>> = empresaName.flatMapLatest { companyId ->
        if (companyId.isNotEmpty()) {
            zplLabelDao.getAllLabels(companyId)
        } else {
            flowOf(emptyList())
        }
